    ...
    <div class="sidebar-menu">
        <div class="menu-section">
            ...
            <div class="menu-dropdown">
                <div class="menu-item has-dropdown {{ in_array($activeMenu, ['dashboard', 'info-admin', 'editor', 'anggota']) ? 'active' : '' }}" onclick="toggleDropdown(this)">
                ...
                <div class="submenu {{ in_array($activeMenu, ['dashboard', 'info-admin', 'editor', 'anggota']) ? 'active' : '' }}">
